      ...
      <div class="widgetContainer">
        <div class="searchContainer">
          <select class="form-select" v-model="selectedSidoCode" @click="updateSelectedGugunList">
            <option v-for="sido in sidoList" :key="sido.name" :value="sido.value">
              {{ sido.name }}
            </option>
          </select>
          <select class="form-select" v-model="selectedGugunCode">
            <option v-for="(value, name) in selectedGugunList" :key="name" :value="value">
              {{ name }}
            </option>
          </select>
        ...
        <div v-if="selectAttraction != null" class="selectContainer" :v-model="selectAttraction">
          ...
          <img
            class="selectAttractionImg"
            :src="
              selectAttraction.firstImage == ''
          ...
          <div class="selectAttractionDataContainer">
            ...
            <div class="buttonContainer">
              <button type="button" class="svgButton" @click="addAttraction">
                ...
                >
                  <path
                    d="M10.5,16.5h-2.5v-3h2.5v-2.5h3v2.5h2.5v3h-2.5v2.5h-3v-2.5ZM24,5.5V24H0V5.5c0-1.93,1.57-3.5,3.5-3.5h2.5V0h3V2h6V0h3V2h2.5c1.93,0,3.5,1.57,3.5,3.5Zm-3,3.5H3v12H21V9Z"
                  />
                </svg>
              </button>
            </div>
